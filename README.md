...
```groovy
compile 'de.mkammerer:argon2-jvm:2.6-SNAPSHOT'
```

Without pre-compiled Argon2 libraries:

```groovy
compile 'de.mkammerer:argon2-jvm-nolibs:2.6-SNAPSHOT'
```
...
See [tested distributions](docs/tested-systems.md) for details on which distributions this has been tested.
